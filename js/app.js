...
function albumRow(album){
  ...
  wrap.className='album-release';
  wrap.setAttribute('data-album-id',album.id);

  wrap.innerHTML=
    '<div class="album-release-main">'+
...
function renderCatalog(cat){
  ...
  tracks
    ...
    .forEach(function(t){c.appendChild(row(t))});
